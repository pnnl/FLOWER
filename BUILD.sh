...
export CMAKE_OPTIONS="-DBoost_NO_SYSTEM_PATHS=TRUE -DBOOST_ROOT=$BOOST_ROOT -DCMAKE_BUILD_TYPE=Release -DENABLE_TESTS=OFF -DCMAKE_CXX_COMPILER=$CMAKE_CXX_COMPILER"
