...
public:
  ...
  inline string calculateItemsPerSecond(time_duration const p_duration, u_int64_t const p_count) const throw()
  {
  ...
  inline ptime getStartTime(void) const throw()
  {
    return(this->start_time);
  }


  inline ptime getFinishTime(void) const throw()
  {
    return(this->finish_time);
  }


  u_int64_t getItemCount(void) const throw()
  {
    return(this->item_stats.getCount());
  }


  u_int64_t getTotalItemCount(void) const throw()
  {
    return(this->total_item_stats.getCount());
  }


  inline string getItemProcessingTime(void) const throw()
  {
    return(to_simple_string(getRunTime()));
  }


  inline string getTotalItemProcessingTime(void) const throw()
  {
    return(to_simple_string(getTotalRunTime()));
  }


  string getItemsPerSecond(void) const throw()
  {
    return(calculateItemsPerSecond(getRunTime(), getItemCount()));
  }


  string getTotalItemsPerSecond(void) const throw()
  {
    return(calculateItemsPerSecond(getTotalRunTime(), getTotalItemCount()));
  }


  inline time_duration getRunTime(void) const throw()
  {
    return(this->run_time);
  }


  inline time_duration getTotalRunTime(void) const throw()
  {
    return(this->total_run_time);
  }


  inline void incrItemStats(void) throw()
  {
    ++this->item_stats;
  ...
  inline void incrItemStats(u_int64_t const p_count) throw()
  {
  ...
  inline void resetItem(void) throw()
  {
  ...
  inline void resetItemTotal(void) throw()
  {
  ...
  inline void setFinishTime(bool const p_update_duration = true) throw()
  {
  ...
  inline void setStartTime(void) throw()
  {
  ...
  ItemCounter(string const & p_name) throw();


  // Destructor

  ~ItemCounter(void) throw()
  {
    return;
  }
...
private:
  ...
  ItemCounter(void) throw();
  ItemCounter(ItemCounter const & p_item_counter) throw();


  // Operators

  ItemCounter &   operator=(ItemCounter const & p_item_counter) throw();
  bool           operator==(ItemCounter const & p_item_counter) const throw();
  bool           operator!=(ItemCounter const & p_item_counter) const throw();
